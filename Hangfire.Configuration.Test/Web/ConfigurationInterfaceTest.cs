...
namespace Hangfire.Configuration.Test.Web
{
    public class ConfigurationInterfaceTest
    {
        ...
        public void ShouldFindConfigurationInterface()
        {
            ...
            var response = system.TestServer.CreateClient().GetAsync("/config").Result;
        ...
        {
            var system = new SystemUnderTest();
            var response = system.TestServer.CreateClient().GetAsync("/configIncorrect").Result;
        ...
        public void ShouldSaveWorkerGoalCount()
        {
            ...
            var response = system.TestServer.CreateClient().PostAsync(
